...
//        возвращаем пользователя на страницу
    ...
    public function actionIndex()
    {
        ...
        require_once ROOT_DIR . '/views/cart/index.php';
        return true;
    }
    ...
    public function actionCheckout()
    {
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($errors == false) {
                ...
                if ($result){
                    ...
                    $adminEmail = 'php.shop@mail.com';
                    $message = 'http://phpshop@mail.com/admin/orders';
                    $subject = 'Новый заказ!';
        ...
        require_once ROOT_DIR. '/views/cart/checkout.php';
        return true;
    }
}